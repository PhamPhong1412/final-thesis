...
#define CCJC_CAST_CCDICTIONARY(__pDict__,__sKey__) dynamic_cast<__Dictionary *>(__pDict__->objectForKey(__sKey__))
...
public:
	...
	//__Dictionary* stringToDic(std::vector<HttpRequestParameter> RequestParameter);
